...
@NamedQueries({
    ...
    @NamedQuery(name = "Transactions.findByCustomer", query = "SELECT t FROM Transactions t WHERE t.customer = :customer"),
    ...
    @NamedQuery(name = "Transactions.findByExtra", query = "SELECT t FROM Transactions t WHERE t.extra = :extra")})
